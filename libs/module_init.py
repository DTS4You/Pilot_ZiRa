...
class Global_WS2812:
    ...
    numpix_1            = 128       # Anz. LEDs im 1. Stripe
    numpix_2            = 128       # Anz. LEDs im 2. Stripe
    numpix_3            = 128       # Anz. LEDs im 3. Stripe
    numpix_4            = 128       # Anz. LEDs im 4. Stripe
    numpix_5            = 128       # Anz. LEDs im 5. Stripe
    numpix_6            = 128       # Anz. LEDs im 6. Stripe
    numpix_7            = 128       # Anz. LEDs im 7. Stripe
    numpix_8            = 128       # Anz. LEDs im 6. Stripe
     
    #--------------------------------------------------------------------------

    seg_01_strip        = 0             #  1. Seg -> Stripe      # 0 -> Boden 1
    seg_01_start        = 0             #  1. Seg -> Start
    seg_01_count        = 128           #  1. Seg -> Anzahl
